...
settings = {
    'limit_streaming': 0.041666666666666664,#0.041666666666666664
    'coherence_json': '{}',
...
#    'attention_type': 'coherence',
    ...
    'truncation_length': 32+1,#128#2048
    ...
    'chat_generation_attempts': 300,#1
    'chat_generation_attempts_min': 1,
    'chat_generation_attempts_max': 1000,#10
    'default_extensions': [],
    'chat_default_extensions': ['gallery'],
#    'preset': 'simple-1',#'simple-1'
    'preset': 'simple-0.0006',#'simple-1'
    'prompt': 'QA',
}
